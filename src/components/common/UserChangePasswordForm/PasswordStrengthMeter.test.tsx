...
describe('checkPassword', () => {
    ...
    test('simple password should show weak', async () => {
        const {getByTestId} = render(<PasswordStrengthMeter password="easypw" />);
    ...
    test('complex password should strong', () => {
        const {getByTestId} = render(<PasswordStrengthMeter password="Str0nKp@55w0rD!4Te5t1nG" />);
        const testElementStrong = getByTestId("component-password-strength-bar");
